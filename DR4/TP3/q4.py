...
# Exibe o valor 8080 em ordem do host (como o sistema o armazena internamente)
print("8080 host order:", 8080)
# Aqui ainda não há conversão — apenas mostra o valor decimal.

# Converte o número 8080 da ordem do host para a ordem da rede (BIG-ENDIAN)
# htons = "host to network short" (16 bits)
print("8080 network order (htons):", socket.htons(8080))
# Em máquinas little-endian (como PCs x86), o valor 8080 vira 53764,
# porque os bytes são trocados de posição: 0x04D2 → 0xD204.

# Empacota o mesmo valor 8080 em bytes no formato de rede (big-endian)
# '!H' significa:
#   !  -> network byte order (BIG-ENDIAN)
#   H  -> unsigned short (16 bits)
print("pack network '!H':", struct.pack("!H", 8080))
